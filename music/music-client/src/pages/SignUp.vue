    ...
    <div class="signUp">
      ...
      <el-form :model="registerForm" :rules="rules" ref="registerForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="手机号" prop="phone_num">
          <el-input v-model="registerForm.phone_num" placeholder="手机号"></el-input>
        </el-form-item>
        ...
        <el-form-item label="个人介绍" prop="introduction">
          <el-input v-model="registerForm.introduction" placeholder="个人介绍"></el-input>
        </el-form-item>
        <el-form-item label="地区" prop="location">
          <v-distpicker style="width:100%;" @selected="onSelected" v-model="registerForm.location" only-province ></v-distpicker>
        </el-form-item>
        <div class="login_btn">
