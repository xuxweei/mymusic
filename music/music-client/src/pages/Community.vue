    ...
    <div class="community_main">
      ...
      <div class="community_left">
        <div class="community_header">
          <el-button style="margin:10px 0 0;" icon="el-icon-edit" type="primary" size="mini"
            @click="dialogVisible = true">发表动态</el-button>
        </div>
          ...
          <ul class="community_list">
            <li class="community_list_item" v-for="(val, index) in data" :key="index">
              ...
              <div class="list_up">
                ...
                <!-- 评论-->
                <div class="up" ref="comment" style="right: 20px" v-on:click="change">
              ...
              <div class="comment_list" v-if="commentVisible">
      ...
      <div class="community_right_aside">
        <div class="user_info_box" v-if="loginIn">
          <li class="face" @click="goCommunity(username)">
            <img :src="attachImageUrl(userpic)" v-if="this.userpic != null" />
          </li>
          <h5 class="user_name" @click="goCommunity(username)">
        ...
        <div>
          <el-form-item>
            ...
            <el-form-item v-if="itemVisible">
              <el-upload v-if="this.addForm.type == 2" class="upload-demo" style="display: flex;" :show-file-list="true"
                action="" :auto-upload="false" :on-change="showLogo" :file-list="ImgfileList">
                <el-button size="mini" type="primary">上传图片</el-button>
              </el-upload>
              <el-upload v-else-if="this.addForm.type == 0" class="upload-demo" :show-file-list="true" action=""
                :auto-upload="false" :on-change="songIden" style="display: flex;" :file-list="songFileList">
                <el-button size="mini" type="primary">上传歌曲</el-button>
              </el-upload>
              <el-upload v-else-if="this.addForm.type == 1" class="upload-demo" :show-file-list="true" action=""
                :auto-upload="false" :on-change="videoIden" style="display: flex;" :file-list="videoFileList">
