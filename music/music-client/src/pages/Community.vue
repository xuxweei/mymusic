                ...
                <div class="list_source">
                  ...
                  <div class="song_box" v-else-if="val.type==0">
                    <div class="song_wrapper">
                      ...
                      <div class="play"
                        @click="toPlay(val.id,val.url,val.songpic,index,getSongName(val.url),val.lyric)">
...
<script>
  ...
  export default {
    ...
    computed: {
      //计算当前搜索结果表里的数据
      data() {
        return this.communityDatas.slice((this.currentPage - 1) * this.pageSize, this.currentPage * this.pageSize);
      },
      ...mapGetters([
        'activeName',
        'loginIn',
