 ...
 * @LastEditTime: 2021-04-29 09:21:12
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \Vue\mymusic\music\music-client\src\components\SongListContent.vue
-->
<template>
  <div class="content_list">
    ...
    <ul class="playlist_list">
      <li
        class="playlist_item"
        v-for="(item, index) in songListContent"
        :key="index"
      >
        <div class="kuo" @click="goAlbum(item, item.name)">
          <img v-lazy="attachImageUrl(item.pic)" class="item_img" />
        </div>
        <h4 class="item_name">
