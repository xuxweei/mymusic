<template>
  <div class="comment">
    ...
    <div class="comment_msg">
      ...
      <el-input class="comment_input" placeholder="请输入内容" v-model="textarea" type="textarea" :rows="3">
      </el-input>
      <el-button type="primary" class="sub_btn" @click="postComment">评论</el-button>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      getComment() {
        ...
        getAllComment(this.type, this.playId,this.userId).then(res => {
